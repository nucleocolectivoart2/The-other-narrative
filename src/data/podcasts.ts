...
export const spotifyShows: SpotifyShow[] = [
  {
    ...
    description: "Periodismo de soluciones, sostenibilidad, regeneración e innovación conducido por Ángela María Gómez."
  },
  {
...
export const spotifyPodcasts: PodcastEpisode[] = [
  ...
  },
  {
    ...
    description: "Una conversación inspiradora y práctica sobre cómo llevar la sostenibilidad del discurso a la implementación real, construyendo modelos empresariales más responsables, medibles y coherentes con los desafíos del planeta.",
  ...
  },
  {
    ...
    showId: "4fIwE8OUNlJkszY6XQZcO5",
    showName: "Planeta Sostenible",
    title: "Ciudades sostenibles el rol de los centros comerciales en el futuro urbano",
    description: "Los centros comerciales ya no son solo lugares de consumo; son espacios de encuentro y convivencia en el corazón de nuestras ciudades. Analizamos cómo están integrando prácticas sostenibles, desde la eficiencia energética hasta la gestión de residuos y el impacto social.",
    url: "https://open.spotify.com/episode/2wpTowFWqAtVAcxBfU1Z0O",
    image: "https://image-cdn-ak.spotifycdn.com/image/ab67656300005f1fe9dc719e69a6ab1da9d7bda7",
    guest: "Líderes de Sostenibilidad Urbana",
    category: "Planeta Sostenible"
  },
  {
    ...
    showId: "4fIwE8OUNlJkszY6XQZcO5",
    showName: "Planeta Sostenible",
    title: "Plásticos y sotenibilidad: Conversación para avanzar hacia la economía circular",
    description: "El plástico está en el centro de uno de los debates más incómodos y necesarios de la sostenibilidad. ¿Es realmente el problema o parte de la solución? Abrimos una conversación que va más allá de los discursos para entender cómo avanzar hacia una economía circular real.",
  ...
  },
  {
    ...
    description: "Un episodio especial grabado desde la Feria del Libro de Bogotá. Una mesa de trabajo con Juan Camilo Pinzón y Mauricio López para conversar sobre cómo conectar la sostenibilidad con el rumbo del país y el papel del pensamiento crítico en la transformación empresarial.",
  ...
  },
  {
    ...
    showId: "4fIwE8OUNlJkszY6XQZcO5",
    showName: "Planeta Sostenible",
    title: "Pilas con el ambiente cuan los residuos se convierten en soluciones.",
    description: "¿A dónde va una pila cuando se agota? Con Alberto Ladino Hernández, director de Pilas con el Ambiente - ANDI, entendemos cómo en Colombia más de 200 millones de pilas han sido recolectadas y transformadas en oportunidades productivas, mostrando que la sostenibilidad empieza en los pequeños hábitos.",
  ...
  },
  {
    ...
    showId: "4fIwE8OUNlJkszY6XQZcO5",
    showName: "Planeta Sostenible",
    title: "La sostenibilidad se construye desde la cultura, una conversación necesaria.",
    description: "¿Y si el mayor reto de la sostenibilidad no fuera técnico... sino cultural? La sostenibilidad se construye desde lo que pensamos, valoramos y decidimos como sociedad. Hablamos de identidad, narrativas y la necesidad de transformar la forma en que imaginamos el mundo.",
  ...
  },
  {
    ...
    showId: "4fIwE8OUNlJkszY6XQZcO5",
    showName: "Planeta Sostenible",
    title: "¿El verdadero reto de la sostenibilidad es técnico… o es de liderazgo?",
    description: "A pesar del conocimiento y las herramientas disponibles, seguimos fragmentados. Exploramos el tipo de liderazgo que el mundo necesita hoy: uno que no simplifique la realidad en bandos, que construya puentes y entienda que la sostenibilidad es una decisión de acción.",
